...
from data.data import TOTAL_LISTERS
        ...
        dbc.Col(
            ...
            children=[
                html.P(
                    className="lead mb-4",
                    children=[
                        f"A 'best-of-the-best' collection of albums assembled by people who care based on the results of a 'Top 10 Albums' survey between {TOTAL_LISTERS} friends.",
                        html.Br(),
                        html.Br(),
